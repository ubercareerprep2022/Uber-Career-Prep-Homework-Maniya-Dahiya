...
* Each entry in the phone book is made up of 2 components: a name
(String) and a
* phone number (long).
* For the purposes of this exercise, you can assume that there are no
duplicate names.
*
* For example, assume we have a phone book with the following data:
Questions? hetals@uber.com, 9
*
